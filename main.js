    ...
    while(true){
     const depositAmount = prompt("Enter a deposit amount: ");
        ...
        if(isNaN(numberDepositAmount)|| numberDepositAmount <= 0){
            console.log("Invalid amount entry! Try again!");
        }else{
    ...
    while(true){
        const lines = prompt("Enter the number of lines to bet on (1-3): ");
           ...
           if(isNaN(numberOfLines) || numberOfLines < 1 || numberOfLines > 3){
               console.log("Invalid number of lines entry! Try again!");
           }else{
...
const game = () => {
    let balance = deposit();
    while(true){
    console.log(`Your balance is KES: ${balance}`);
    ...
    if(winnings == 0){
        console.log(`Sorry! you won ${winnings}`);
    }else{
